<?php $__env->startSection('title', 'Chatbot - Campus Chatbot'); ?>
                ...
                <div class="card chat-card">
                    ...
                    <div class="card-body p-0" style="overflow-y: scroll" id="chatMessagesContainer">
                        <div class="chat-messages" id="chatMessages">
                            ...
                            <?php $__currentLoopData = $chatHistories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="message user-message">
                                    <div class="message-avatar">
                                        <i class="fas fa-user"></i>
                                    </div>
                                    <div class="message-content">
                                        <div class="message-text"><?php echo e($chat->question); ?></div>
                                        <div class="message-time"><?php echo e($chat->created_at->format('H:i')); ?></div>
                                    </div>
                                </div>
                                <div class="message bot-message">
                                    ...
                                    <div class="message-content">
                                        <div class="message-text"><?php echo nl2br(e($chat->answer)); ?></div>
                                        <div class="message-time">
                                            <?php echo e($chat->created_at->format('H:i')); ?>

                                            <?php if($chat->confidence_score > 0): ?>
                                                <span class="confidence-badge ms-2">
                                                    <i class="fas fa-check-circle"></i>
                                                    <?php echo e(number_format($chat->confidence_score, 0)); ?>%
                                                </span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\LARAVEL\CampusChatbot\resources\views/chatbot/index.blade.php ENDPATH**/ ?>