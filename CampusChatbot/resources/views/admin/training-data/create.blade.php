...
@section('title', 'Tambah Training Data - Admin')
@section('page-title', 'Tambah Training Data')
        ...
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.training-data.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="category" class="form-control"
                                        value="{{ old('category', 'umum') }}" list="categoryList" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="priority" class="form-control"
                                        value="{{ old('priority', 5) }}" min="0" max="10" required>
