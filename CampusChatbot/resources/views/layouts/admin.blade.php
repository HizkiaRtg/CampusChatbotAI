...
<head>
    ...
    <title>@yield('title', 'Admin - Campus Chatbot')</title>
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-menu">
                ...
                <a href="{{ route('admin.training-data.index') }}"
                    class="menu-item {{ request()->routeIs('admin.training-data.*') ? 'active' : '' }}">
                    <i class="fas fa-database"></i>
                    <span>Training Data</span>
                </a>
                <a href="{{ route('admin.chat-history.index') }}"
                    class="menu-item {{ request()->routeIs('admin.chat-history.*') ? 'active' : '' }}">
                    <i class="fas fa-history"></i>
                    <span>Riwayat Chat</span>
                </a>
                <a href="{{ route('chatbot.index') }}" class="menu-item">
