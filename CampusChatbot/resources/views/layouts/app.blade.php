...
<head>
    ...
    <title>@yield('title', 'Campus Chatbot')</title>
...
<body>
    ...
    {{-- <footer class="text-center">
        <div class="container">
            <p class="mb-0">&copy; {{ date('Y') }} Campus Chatbot. All rights reserved.</p>
            <p class="mb-0 mt-2 small">Powered by Advanced AI Matching Algorithm</p>
        </div>
    </footer> --}}
